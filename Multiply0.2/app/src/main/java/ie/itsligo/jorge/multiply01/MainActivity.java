...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText S1 = (EditText) findViewById(R.id.editText);
        final EditText S2=(EditText) findViewById(R.id.editText2);
        Button BtMulti =  (Button) findViewById(R.id.button);
        final TextView tvResult = (TextView) findViewById(R.id.textView);
        Button BtPage =  (Button) findViewById(R.id.buttonPage);

        BtMulti.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                int aux1 = Integer.valueOf(S1.getText().toString());
                int aux2 = Integer.valueOf(S2.getText().toString());
